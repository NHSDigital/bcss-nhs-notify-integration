...
class AuthManager():
  ...
  def get_access_token(self) -> str:
    ...
    reponse = self.api_client.make_request("POST", "", data=body, headers=headers, params=None)
  ...
  def generate_auth_jwt(self) -> str:
    ...
    return Util.generate_jwt(algorithm, private_key, headers, payload, expiry_minutes=5)